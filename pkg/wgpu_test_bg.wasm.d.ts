...
export function wasm_bindgen__convert__closures__invoke0_mut__h16e13354e67e0e0e(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h27c89ee99de027a1(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h00d1a8a8b12ba9e9(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h67e7f88d0d82460b(a: number, b: number, c: number): void;
